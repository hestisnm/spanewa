...
if (isset($_POST['submit'])) {
    ...
    // Ambil waktu saat ini jika tidak diinput oleh user
    ...
    $sql = "UPDATE fasilitas SET title='$title', author='$author', image='$image', date='$date' WHERE id=$id";
...
<div class="container">
    ...
    <div class="card">
        <form method="POST" action="" enctype="multipart/form-data">
            ...
            <div class="preview">
                <img src="fasilitas/upload/<?php echo htmlspecialchars($row['image']); ?>" alt="Preview Gambar">
            </div>
            ...
            <button type="submit" name="submit">Update Fasilitas</button>
        </form>
    </div>
</div>
