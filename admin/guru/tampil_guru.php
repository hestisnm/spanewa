        ...
        <table>
            ...
            <?php while($row = $result->fetch_assoc()): ?>
                <tr>
                    ...
                    <td>
                        <a href="view_guru.php?id=<?php echo $row['id']; ?>">Baca</a> |
                        <a href="edit_guru.php?id=<?php echo $row['id']; ?>">Edit</a> |
                        <a href="delete_guru.php?id=<?php echo $row['id']; ?>" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?')">Delete</a>
                    </td>
                </tr>
            <?php endwhile; ?>
        </table>
