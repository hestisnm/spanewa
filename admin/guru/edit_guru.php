...
if (isset($_POST['submit'])) {
    ...
    $sql = "UPDATE guru SET nama='$nama', mapel='$mapel', image='$image', date='$date' WHERE id=$id";
...
<form method="POST" action="" enctype="multipart/form-data">
    Nama Guru: <input type="text" name="nama" value="<?php echo
                                                    $row['nama']; ?>" required><br>
    Mata Pelajaran: <input type="text" name="mapel" value="<?php echo
                                                    $row['mapel']; ?>" required><br>
